...
function setupMobileCarousel() {
    ...
    function showNextItem() {
        ...
        if (nextItemIndex !== -1) {
            ...
            // No more valid items for current day - show "no more eve// Global variable to store all events data
let allEventsData = [];
...
setInterval(loadEventPreferences, 30000); // Refresh every 30 secondsnts" card
            if (!noMoreEventsCard) {
                noMoreEventsCard = createNoMoreEventsCard();
            }
            noMoreEventsCard.style.display = 'block';
